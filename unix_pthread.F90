...
#elif defined (_WIN32)
    ! Dummy values for Windows compatibility
    integer(kind=c_int), parameter :: PTHREAD_CREATE_DETACHED = 0
    integer(kind=c_int), parameter :: PTHREAD_CANCEL_ENABLE = 0
    integer(kind=c_int), parameter :: PTHREAD_CANCEL_DISABLE = 0
    integer(kind=c_int), parameter :: PTHREAD_CANCEL_DEFERRED = 0
    integer(kind=c_int), parameter :: PTHREAD_CANCEL_ASYNCHRONOUS = 0
    integer(kind=c_int), parameter :: PTHREAD_CANCELED = 0
    integer(kind=c_int), parameter :: PTHREAD_EXPLICIT_SCHED = 0
    integer(kind=c_int), parameter :: PTHREAD_PROCESS_PRIVATE = 0
    integer(kind=c_int), parameter :: PTHREAD_MUTEX_NORMAL = 0
    integer(kind=c_int), parameter :: PTHREAD_MUTEX_ERRORCHECK = 0
    integer(kind=c_int), parameter :: PTHREAD_MUTEX_RECURSIVE = 0
    integer, parameter :: PTHREAD_SIZE = 0
    integer, parameter :: PTHREAD_MUTEX_SIZE = 0
#endif
